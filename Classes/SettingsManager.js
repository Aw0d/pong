class SettingsManager {
  constructor() {
    ...
    this.useSameSettingsForBothPaddlesCheckbox = document.getElementById(
      "sameSettingsBothPaddles"
    );
  }
  ...
  init() {
    ...
    document
      .getElementById("sameSettingsBothPaddles")
      .addEventListener("change", this.menuSettingsPaddles.bind(this));
  }
  ...
  updateSettings(e) {
    if (e.target.validity.valid) {
      // Si la valeur dans input est valide
      ...
      // Si la valeur dans input est invalide
